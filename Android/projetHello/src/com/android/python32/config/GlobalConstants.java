...
package com.android.python32.config;

public class GlobalConstants {

	public static final String PYTHON_MAIN_SCRIPT_NAME = "mon_hello.py";
	public static final String PYTHON_PROJECT_ZIP_NAME = "mon_projet.zip";
	...
	public static final String LOG_TAG = "MonHello";
}
